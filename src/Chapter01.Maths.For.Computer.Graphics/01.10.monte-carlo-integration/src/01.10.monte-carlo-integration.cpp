...
inline float
Lerp(const float *F, short Index, float T, float Max)
{
    float Result = F[Index + 1]*(1 - T) + F[Index]*T;
    return Result;
}
...
MonteCarloIntegration(const short &CurveIndex, float &X, float &Y, float &Z)
{
    ...
    for(int I = 0; I < NumSamples; ++I)
    {
        ...
        float Random01 = Rand01();
        float Lambda = Random01 * (LambdaMax - LambdaMin);
        ...
        float Spd = Lerp(SpectralData[CurveIndex], J, T, NumBins - 1);
