...
private:
    ...
    // point using this information. Shading depends on the surface property (is
    // it transparent, reflective, diffuse). The function returns a color for
    // the ray. If the ray intersects an object that is the color of the object
